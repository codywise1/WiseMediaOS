    ...
    <div className="space-y-6 pb-20 md:pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {isAdmin && (
            <div className="glass-card rounded-2xl p-6">
              <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Display, Inter, sans-serif' }}>Actions</h2>
          ...
          <div className="glass-card rounded-2xl p-6">
            <h2 className="text-xl font-bold text-white mb-4" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Display, Inter, sans-serif' }}>Summary</h2>
            <div className="space-y-3">

  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-24">
      ...
      <div className="rounded-3xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-10">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-white leading-tight mb-3" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Display, Inter, sans-serif' }}>
      ...
      <div className="rounded-3xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-10">
        ...
        <div className="flex justify-between items-center pt-6 border-t border-white/[0.06]">
          ...
          <span className="text-3xl font-bold text-white" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Display, Inter, sans-serif' }}>

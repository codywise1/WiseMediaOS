  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass-card neon-glow rounded-2xl p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <h1 className="text-3xl font-bold gradient-text mb-2" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Text, Inter, sans-serif' }}>Appointments</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {appointmentTypes.slice(0, 3).map((type, index) => (
            <div key={index} className="glass-card rounded-xl p-6 card-hover cursor-pointer">
              ...
              <h3 className="text-lg font-bold text-white mb-2" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Text, Inter, sans-serif' }}>{type.name}</h3>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-xl font-bold text-white" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Text, Inter, sans-serif' }}>Upcoming Appointments</h2>
            ...
            <div key={appointment.id} className="glass-card rounded-xl p-6 card-hover neon-glow">
              <div className="flex flex-col gap-3 mb-4 min-w-0 sm:flex-row sm:items-start sm:justify-between">
                <div className="flex items-start gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-lg font-bold text-white truncate" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, SF Pro Text, Inter, sans-serif' }}>{appointment.title}</h3>

...
export default function ProjectDetail({ currentUser }: ProjectDetailProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card neon-glow rounded-2xl p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col gap-4 min-w-0 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0 flex-1">
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2 min-w-0 truncate" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              {project.name}
            </h1>
      ...
      {/* Main Details Grid */}
      <div className="glass-card neon-glow rounded-2xl p-4 sm:p-6 lg:p-8">
        <h2 className="text-xl font-black text-white uppercase tracking-wider mb-8" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
          Project Details
        </h2>

...
import { Home, Folder, FileText, Calendar, ClipboardList, CircleUser as UserCircle, LogOut, Pencil, X, MoreHorizontal, MessageCircle, MessagesSquare, BookOpen, Copy, LayoutGrid, ChevronLeft, ChevronRight, BarChart3, Users, SprayCan } from 'lucide-react'
...
export default function Layout({ children, currentUser, onLogout, onUpdateProfile }: LayoutProps) {
  ...
  const isFixedHeightRoute = location.pathname.startsWith('/community/messages') || location.pathname.startsWith('/meetings/live') || location.pathname === '/projects' || location.pathname === '/meetings' || location.pathname === '/notes'
